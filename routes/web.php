...
Route::get('/products/{id}', [ProductController::class, 'index_product'])->name('products');
Route::get('/products/{id}/details', [ProductController::class, 'show_product'])->name('show_product');
...
Route::middleware('admin')->group(function() {
  ...
  Route::get('/top_category/create', [CategoryController::class, 'top_create'])->name('create_topcategory');
  Route::post('/top_category/create', [CategoryController::class, 'top_store'])->name('store_topcategory');
  Route::get('/main_category/create', [CategoryController::class, 'main_create'])->name('create_maincategory');
  Route::post('/main_category/create', [CategoryController::class, 'main_store'])->name('store_maincategory');
  Route::get('/get_category',[CategoryController::class,'getcat'])->name('get_category');
});
